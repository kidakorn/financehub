      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-2">Sign in to your financial dashboard</p>
          </div>
          ...
          <form action={action} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full h-10 px-3 rounded-lg border border-gray-200 bg-white text-sm outline-none
            ...
            <button
              type="submit"
              disabled={pending}
              className="w-full h-10 bg-gray-900 text-white text-sm font-semibold rounded-lg
                hover:bg-black transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-2
          ...
          <form action={loginWithGoogle}>
            <button
              type="submit"
              className="w-full h-10 flex items-center justify-center gap-3 border border-gray-200 rounded-lg
